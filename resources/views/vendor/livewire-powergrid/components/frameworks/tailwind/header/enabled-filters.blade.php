        ...
        @if (count($enabledFilters) > 1)
            <div class="flex group items-center gap-3 cursor-pointer">
                <span
                    ...
                    class="select-none rounded-md outline-none inline-flex items-center border px-2 py-0.5 font-bold text-xs border-pg-primary-500 bg-pg-primary-100 text-pg-primary-600 hover:text-pg-primary-500"
                >
            ...
            @isset($filter['label'])
                ...
                >
                    <span
                        ...
                        class="select-none rounded-md outline-none inline-flex items-center border px-2 py-0.5 font-bold text-xs border-pg-primary-300 bg-white text-pg-primary-600 hover:text-pg-primary-500"
                    >
                        {{ $filter['label'] }}
                        <x-livewire-powergrid::icons.x class="w-4 h-4 ml-1" />
                    </span>
